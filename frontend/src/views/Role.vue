<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column label="操作" width="280" align="center">
        <template slot-scope="scope">
          <el-button type="info" @click="showPermissionAssignDialog(scope.row)">分配权限
          </el-button>
    ...
    <el-dialog title="权限分配" :visible.sync="permissionDialogVisible" width="30%">
      <el-tree :data="permissionData" show-checkbox node-key="id" default-expand-all ref="tree" :props="defaultProps">
      </el-tree>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    saveRolePermission() {
      ...
      this.request.post("/role/saveRolePermission/" + this.roleId, permissionIds ).then(res => {
        if (res.code === '200') {
    ...
    showPermissionAssignDialog(role) {
      ...
      // 请求当前角色的权限 IDs
      this.request.get("/role/listPermissionIdsByRoleId/" + this.roleId).then(res => {
